...
('CUS001','Aarav Sharma',820,'Mumbai','DEV-101',1,'verified'),
('CUS002','Priya Nair',1430,'Bengaluru','DEV-204',0,'verified'),
('CUS003','Rohan Mehta',95,'Delhi','DEV-388',5,'review'),
('CUS004','Sara Khan',2200,'Chennai','DEV-490',2,'verified'),
('CUS005','Vikram Rao',310,'Kolkata','DEV-554',3,'pending'),
('CUS006','Neha Verma',760,'Mumbai','DEV-612',1,'verified'),
...
('CUS010','Ananya Das',1180,'Kolkata','DEV-978',1,'verified');
